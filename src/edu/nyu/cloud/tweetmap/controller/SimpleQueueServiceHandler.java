 ...
 */
public class SimpleQueueServiceHandler implements SimpleQueueServiceCallback {
	AmazonSQS sqs;
	...
	public SimpleQueueServiceHandler(AmazonSQS sqs) {
		super();
		this.sqs = sqs;
	}

	public void createQueue(String myQueueName) {
		// Create a queue
//		boolean exist = false;
//		for (String queueUrl : sqs.listQueues().getQueueUrls()) {
//			if ("https://sqs.us-east-1.amazonaws.com/545723986805/MyQueue".equalsIgnoreCase(queueUrl)) {
//				exist = true;
//				break;
//			}
...
//		}
//		if (!exist) {
			System.out.println("Creating a new SQS queue called "+myQueueName+" \n");
			CreateQueueRequest createQueueRequest = new CreateQueueRequest(
					myQueueName);
			String myQueueUrlRes = sqs.createQueue(createQueueRequest)
					.getQueueUrl();
			setMyQueueUrl(myQueueUrlRes);
//		}
	}

	@Override
	public void sendMessage(String messageBody, String msgID) {
		...
		messageAttributes.put("tweetID", new MessageAttributeValue()
				.withDataType("String").withStringValue(msgID));
		SendMessageRequest request = new SendMessageRequest();
		request.withMessageBody(messageBody);
		request.withQueueUrl(getMyQueueUrl());
...
//			Map<String, MessageAttributeValue> messageAttributes = new HashMap<>();
//			messageAttributes.put("tweetID", new MessageAttributeValue()
//					.withDataType("String").withStringValue("1231213213"));
//			SendMessageRequest request = new SendMessageRequest();
...
//						+ message.getMessageAttributes().get("tweetID")
//								.getStringValue());
